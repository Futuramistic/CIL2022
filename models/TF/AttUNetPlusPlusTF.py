...
def AttUNetPlusPlusTF(input_shape=DEFAULT_TF_INPUT_SHAPE,
    ...
    def __build_model(inputs):
        ...
        att_x00, x0_1 = Attention_PlusPlus_Block(name=name+"-att-pp-1", filters=nb_filters[0],
                                                 **up_args)(x=x0_0, g=x1_0, down=None, to_concat=[])
        att_x10, x1_1 = Attention_PlusPlus_Block(name=name+"-att-pp-2", filters=nb_filters[1],
                                                 **up_args)(x=x1_0, g=x2_0, down=x0_1, to_concat=[])
        att_x20, x2_1 = Attention_PlusPlus_Block(name=name+"-att-pp-3", filters=nb_filters[2],
                                                 **up_args)(x=x2_0, g=x3_0, down=x1_1, to_concat=[])
        att_x30, x3_1 = Attention_PlusPlus_Block(name=name+"-att-pp-4", filters=nb_filters[3],
                                                 **up_args)(x=x3_0, g=x4_0, down=x2_1, to_concat=[])

        att_x01, x0_2 = Attention_PlusPlus_Block(name=name+"-att-pp-5", filters=nb_filters[0],
                                                 **up_args)(x=x0_1, g=x1_1, down=None, to_concat=[att_x00])
        att_x11, x1_2 = Attention_PlusPlus_Block(name=name+"-att-pp-6", filters=nb_filters[1],
                                                 **up_args)(x=x1_1, g=x2_1, down=x0_2, to_concat=[att_x10])
        att_x21, x2_2 = Attention_PlusPlus_Block(name=name+"-att-pp-7", filters=nb_filters[2],
                                                 **up_args)(x=x2_1, g=x3_1, down=x1_2, to_concat=[att_x20])

        att_x02, x0_3 = Attention_PlusPlus_Block(name=name+"-att-pp-8", filters=nb_filters[0],
                                                 **up_args)(x=x0_2, g=x1_2, down=None, to_concat=[att_x00, att_x01])
        att_x12, x1_3 = Attention_PlusPlus_Block(name=name+"-att-pp-9", filters=nb_filters[1],
                                                 **up_args)(x=x1_2, g=x2_2, down=x0_3, to_concat=[att_x10, att_x11])

        att_x03, x0_4 = Attention_PlusPlus_Block(name=name+"-att-pp-x", filters=nb_filters[0],
                                                 **up_args)(x=x0_3, g=x1_3, down=None,
                                                            to_concat=[att_x00, att_x01, att_x02])
