...
class BEiT(nn.Module):
    ...
    def __init__(self, img_size=400, patch_size=16, in_chans=3, num_classes=2, embed_dim=1024,
                 depth=24, num_heads=16, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0.,
                 attn_drop_rate=0., drop_path_rate=0.3, hybrid_backbone=None, norm_layer=None,
