...
class FFT_UNet(nn.Module):
    def __init__(self, n_channels=6, n_classes=2, bilinear=True):
        super(FFT_UNet, self).__init__()
    ...
    def forward(self, x):
        ...
        output = torch.unsqueeze(output, 1).type(torch.float32)
