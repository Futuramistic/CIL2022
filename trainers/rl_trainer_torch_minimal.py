...
class TorchRLTrainerMinimal(TorchTrainer):
    def __init__(self, dataloader, model, preprocessing=None,
                 ...
                 rewards = None, blobs_removal_threshold=0, hyper_seg_threshold=False, use_sample_weighting=False, use_adaboost=False):
        """
        ...
        # use_sampling_weighting and adaboost not needed in RL
