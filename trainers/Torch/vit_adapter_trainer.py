...
class ViTAdapterTrainer(TorchTrainer):
    """
    Trainer for the ViT-Adapter model.
    Based on :
    based on https://github.com/czczup/ViT-Adapter/blob/main/segmentation/configs/cityscapes/mask2former_beit_adapter_large_896_80k_cityscapes_ss.py
    """
    ...
    def __init__(self, dataloader, model, experiment_name=None, run_name=None, split=None, num_epochs=None,
        ...
        if optimizer_or_lr is None:
            optimizer_or_lr = ViTAdapterTrainer.get_default_optimizer_with_lr(2e-5, model)
        elif isinstance(optimizer_or_lr, int) or isinstance(optimizer_or_lr, float):
            optimizer_or_lr = ViTAdapterTrainer.get_default_optimizer_with_lr(float(optimizer_or_lr), model)
