# code taken and adapted from https://pyimagesearch.com/2021/11/08/u-net-training-image-segmentation-models-in-pytorch/ and pytorch Data Tutorial
...
class SegmentationDataset(Dataset):
    def __init__(self, imagePath, groundTruthPath=None, transforms=None):
        self.imagePaths = []
